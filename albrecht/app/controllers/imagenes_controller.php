	...
	if( !empty( $this->data ) )
	{
		...
		else
		{
			...
			else
			{
				...
				{
					if( $this->imagen->resize( $this->imagen->id ) )
					{
 						echo "<div style=\"color: blue\">Imagen redimensionada correctamente</div>";
					}
					else
					{
						echo "<div style=\"color: red\">No se pudo redimensionar la imagen</div>";
					}
