...
<table cellpadding="0" border="0" cellspacing="0" width="800" class="tabla-general">
  <tbody>
    ...
    <tr>
      ...
      <td valing="top" rowspan="2" style="margin-left: 2px; padding-left: 8px; padding-right: 8px;" align="left">
		<div id="main">
    ...
    <tr class="menu-abajo">
      <td colspan="11" class="menu-abajo-item">
		...
		<?php echo $html->image( 'separador.png' ); ?>
		<?php echo $html->image( 'ubicacion.png', array( 'url' => '/pages/ubicacion' ) ); ?>
		<?php echo $html->image( 'separador.png' ); ?>
