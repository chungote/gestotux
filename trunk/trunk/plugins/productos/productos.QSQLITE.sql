CREATE TABLE IF NOT EXISTS producto (id INTEGER PRIMARY KEY AUTOINCREMENT, id_categoria NUMERIC, nombre TEXT NOT NULL, precio_costo NUMERIC, precio_venta NUMERIC, descripcion BLOB, marca TEXT, stock NUMERIC DEFAULT NULL );
