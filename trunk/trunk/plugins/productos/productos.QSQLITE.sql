CREATE TABLE IF NOT EXISTS producto (id INTEGER PRIMARY KEY AUTOINCREMENT, id_categoria NUMERIC, nombre TEXT, precio_costo NUMERIC, precio_venta NUMERIC, descripcion BLOB, marca TEXT);
