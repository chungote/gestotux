    ...
    QWidget(parent)
{
    ...
    QPushButton *prevMonth = new QPushButton( this );
    prevMonth->setIcon( QIcon(":/imagenes/anterior.png") );
    ...
    QPushButton *nextMonth = new QPushButton( this );
    nextMonth->setIcon( QIcon(":/imagenes/siguiente.png") );
    ...
    QPushButton *prevWeek = new QPushButton(QIcon(":/imagenes/anterior.png"), "");
    ...
    QPushButton *nextWeek = new QPushButton(QIcon(":/imagenes/siguiente.png"), "");
    ...
    QPushButton *prevDay = new QPushButton(QIcon(":/imagenes/anterior.png"), "");
    ...
    QPushButton *nextDay = new QPushButton(QIcon(":/imagenes/siguiente.png"), "");
    ...
    QLabel *multiLabel = new QLabel(tr("Mostrar semanas enteras"));
    rangeLayout->addWidget(multiLabel);

    QPushButton *nextRange = new QPushButton(QIcon(":/imagenes/siguiente.png"), "");
