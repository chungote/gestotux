...
HTMLstr += "<table width='200px' cellspacing='0' cellpadding='0' border='1'>\n";
HTMLstr += "<tr><td bgcolor='darkblue'>\n";
HTMLstr += "\n";
HTMLstr += "<table border='0' cols='3' width='100%'>\n";
HTMLstr += "<tr>\n";
HTMLstr += "<td><b><font color='white'>A&ntilde;o:</font></b></td>\n";
HTMLstr += "\n";
if (n)
{
	HTMLstr += "<td align='right' width='40'>\n";
	HTMLstr += "<a href=\"javascript:prevYear();\"><font color='white' size=-2>Ant</font></a>\n";
	HTMLstr += "<a href=\"javascript:nextYear();\"><font color='white' size=-2>Sig</font></a>\n";
}
if (ie||ns6)
{
	HTMLstr += "<td align='right' width='80'>\n";
HTMLstr += "<a href=\"javascript:prevYear();\" style='text-decoration: none;'><font color='white' size=-2>Ant</font></a>\n";
HTMLstr += "<a href=\"javascript:nextYear();\" style='text-decoration: none;'><font color='white' size=-2>Sig</font></a>\n";
}
HTMLstr += "</td>\n";
HTMLstr += "\n";
...
HTMLstr += "</tr>\n";
HTMLstr += "<tr>\n";
HTMLstr += "<td><b><font color='white'>Mes:</font></b></td>\n";
HTMLstr += "\n";
HTMLstr += "<td align='right'>\n";
if (n)
{
	HTMLstr += "<a href=\"javascript:prevMonth();\"><font color='white' size=-2>Ant</font></a>\n";
	HTMLstr += "<a href=\"javascript:nextMonth();\"><font color='white' size=-2>Sig</font></a>\n";
}
if (ie||ns6)
{
HTMLstr += "<a href=\"javascript:prevMonth();\" style='text-decoration: none;'><font color='white' size=-2>Ant</font></a>\n";
HTMLstr += "<a href=\"javascript:nextMonth();\" style='text-decoration: none;'><font color='white' size=-2>Sig</font></a>\n";
}
HTMLstr += "</td>\n";
HTMLstr += "\n";
HTMLstr += "<td align='left'>\n";
...
HTMLstr += "<font color='#99ffff'><b>Diciembre</b></font>\n";
if (ie||ns6)HTMLstr += "<div>\n";
if (n) HTMLstr += "</layer></ilayer>\n";
HTMLstr += "</td>\n";
HTMLstr += "\n";
...
HTMLstr += "<tr>\n";
HTMLstr += "<td width='20'><b>Dom</b></td>\n";
HTMLstr += "<td width='20'><b>Lun</b></td>\n";
HTMLstr += "<td width='20'><b>Mar</b></td>\n";
HTMLstr += "<td width='20'><b>Mie</b></td>\n";
HTMLstr += "<td width='20'><b>Jue</b></td>\n";
HTMLstr += "<td width='20'><b>Vie</b></td>\n";
HTMLstr += "<td width='20'><b>Sab</b></td>\n";
HTMLstr += "</tr>\n";
HTMLstr += "<tr>\n";
HTMLstr += "<td colspan=7>\n";
if (ie||ns6)HTMLstr += "<div style='position: relative;'>";
if (n) HTMLstr += "<ilayer id='idMenuContainer' height='120px' width='200px'>\n";
